...
A collection of one-click buttons and scripts for deploying [code-server](https://github.com/STEVENTAN100/code-serv) to various cloud hosting platforms. The fastest way to get a code-server environment! ☁️
